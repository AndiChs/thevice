...
@section('content')
    <div class="panel panel-dark">
        ...
        <div class="panel-body">
            ...
            This Privacy Policy governs the manner in which thevice.ro collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://thevice.ro">http://thevice.ro</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by thevice.ro.<br><br>
            ...
            thevice.ro may collect and use Users personal information for the following purposes:<br>
            <ul>
            ...
            thevice.ro has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>
            ...
            This document was last updated on June 27, 2017.<br>
        </div>
    </div>
@endsection